...
from custom_policy_ppo import modified_cnn
...
class CustomCnnPolicy(FeedForwardPolicy):
    ...
    def __init__(
        self, sess, ob_space, ac_space, n_env, n_steps, n_batch, reuse=False, obs_phs=None, dueling=True, **_kwargs
    ):
...
class CustomLnCnnPolicy(FeedForwardPolicy):
    """
    ...
    def __init__(
        ...
        super(CustomLnCnnPolicy, self).__init__(
            sess,
            ob_space,
            ac_space,
            n_env,
...
class CustomLnMlpPolicy(FeedForwardPolicy):
    """
    ...
    def __init__(
        ...
        super(CustomLnMlpPolicy, self).__init__(
            sess,
            ob_space,
            ac_space,
            n_env,
